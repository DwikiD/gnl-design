...
<head>
  ...
  <!-- Vendor CSS Files -->
  <link href="assets/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet"> <!-- bootstrap -->
  <link href="assets/vendor/boxicons/css/boxicons.min.css" rel="stylesheet"> <!-- icon box -->
  <link href="assets/vendor/owl.carousel/assets/owl.carousel.min.css" rel="stylesheet"> <!-- Carousel -->
  <link href="assets/vendor/aos/aos.css" rel="stylesheet"> <!-- animation -->
...
<body>
  ...
  <header id="header" class="fixed-top bg-white">
    <div class="container d-flex align-items-center">
      ...
      <!-- <h1 class="logo mr-auto"><a href="index.html">GnL</a></h1> -->
      ...
      <a href="<?= base_url('auth') ?>" class="get-started-btn scrollto">Get Started</a>
  ...
  <section id="hero" class="d-flex align-items-center">
    ...
    <div class="container d-flex flex-column align-items-center justify-content-center" data-aos="fade-up">
      <h1>Create Better Your Design With GnL Course</h1>
      <h2>We are team of talanted designers making your creativity more powerfull</h2>
      <a href="#about" class="btn-get-started scrollto">Let's Learn</a>
      <img src="assets/img/hero-01.png" class="img-fluid hero-img" alt="" data-aos="zoom-in" data-aos-delay="150">
    </div>
  ...
  <main id="main">
      ...
      <div class="container">
        ...
        <div class="row no-gutters">
          <div class="content col-xl-5 d-flex align-items-stretch" data-aos="fade-right">
            <div class="content">
              <h3>Kenapa harus belajar di kami ?</h3>
              <p>
              ...
              <a href="<?= base_url('auth') ?>" class="about-btn">Bergabung<i class="bx bx-chevron-right"></i></a>
            </div>
          </div>
    ...
    <section id="features" class="features" data-aos="fade-up">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Alasan harus belajar kami</h2>
        </div>
    ...
    <section id="services" class="services">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Layanan</h2>
          <p>Berikut adalah layanan di ecourse design GnL yang bisa kalian nikmati.</p>
        </div>
    ...
    <section id="testimonials" class="testimonials section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Testimoni</h2>
          <p>Apa kata mereka yang sudah merasakan layanan ecourse design di GnL</p>
        </div>
        ...
        <div class="owl-carousel testimonials-carousel">
          ...
          <div class="testimonial-item">
            <p>
              ...
              Setelah belajar di GnL saya merasakan banyak benefit yang bisa saya manfaatkan untuk menunjang produktivitas startup saya.
    ...
    <section id="contact" class="contact section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Kontak</h2>
          <p>Selalu terhubung dengan kami dan dapatkan penawaran dari harga terbaik dari kami.</p>
        </div>
  ...
  <footer id="footer">
    <div class="container d-md-flex py-4">
      <div class="mr-md-auto text-center text-md-left">
        <div class="copyright">
          &copy; Copyright <strong>GnL</strong> by Dinasti Motekar Academy.
        </div>
      </div>
    </div>
  </footer>
  ...
  <script src="assets/vendor/jquery.easing/jquery.easing.min.js"></script> <!-- scrolling transtition -->
  <script src="assets/vendor/php-email-form/validate.js"></script> <!-- email validate -->
  <script src="assets/vendor/owl.carousel/owl.carousel.min.js"></script> <!-- carousel -->
  <script src="assets/vendor/isotope-layout/isotope.pkgd.min.js"></script> <!-- layout and grid sort -->
  <script src="assets/vendor/aos/aos.js"></script> <!-- animation js -->
